...
import { Users, Calendar, BarChart3, Eye, TrendingUp } from "lucide-react";
import { Study } from "@/types/study";
import { useLanguage } from "@/contexts/LanguageContext";
import RoundDetails from "./RoundDetails";

interface DelphiTraditionalProps {
  study: Study;
}

const DelphiTraditional = ({ study }: DelphiTraditionalProps) => {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge variant="secondary">{t('study.traditional')}</Badge>
          </CardTitle>
...
export default DelphiTraditional;
